...
Class ExcelMonitoring extends CI_Controller{
    ...
    function cetakMonitoring(){
        ...
        $object->getActiveSheet()->getStyle("Z1:AX1")->applyFromArray(
                array(
                    'fill' => array(
                        'type' => PHPExcel_Style_Fill::FILL_SOLID,
        ...
        $AllData = $this->pagemodel->ambilOPmonitor();
        ...
        foreach($AllData as $row)
        {
           $object->getActiveSheet()->setCellValueByColumnAndRow(0, $excel_row, $row->no_transaksi);
            ...
            //OP
            $object->getActiveSheet()->setCellValueByColumnAndRow(25, $excel_row, $row->no_transaksiin);
            $object->getActiveSheet()->setCellValueByColumnAndRow(26, $excel_row, $row->IMO_in);
            $object->getActiveSheet()->setCellValueByColumnAndRow(27, $excel_row, $row->no_container);
            $object->getActiveSheet()->setCellValueByColumnAndRow(28, $excel_row, $row->name_cust_in); 
            $object->getActiveSheet()->setCellValueByColumnAndRow(29, $excel_row, $row->no_shipment_in); 
            $object->getActiveSheet()->setCellValueByColumnAndRow(30, $excel_row, $row->no_shipment2_in); 
            $object->getActiveSheet()->setCellValueByColumnAndRow(31, $excel_row, $row->no_seal_in); 
            $object->getActiveSheet()->setCellValueByColumnAndRow(32, $excel_row, $row->full_empty_in);
            $object->getActiveSheet()->setCellValueByColumnAndRow(33, $excel_row, $row->reefer_dry_in); 
            $object->getActiveSheet()->setCellValueByColumnAndRow(34, $excel_row, $row->stuff_date_in);
            $object->getActiveSheet()->setCellValueByColumnAndRow(35, $excel_row, $row->in_out_in); 
            $object->getActiveSheet()->setCellValueByColumnAndRow(36, $excel_row, $row->origin_town_in);
            $object->getActiveSheet()->setCellValueByColumnAndRow(37, $excel_row, $row->dest_town_in); 
            $object->getActiveSheet()->setCellValueByColumnAndRow(38, $excel_row, $row->vessel_name_in); 
            $object->getActiveSheet()->setCellValueByColumnAndRow(39, $excel_row, $row->deliv_date_in); 
            $object->getActiveSheet()->setCellValueByColumnAndRow(40, $excel_row, $row->arv_at_dest_in);
            $object->getActiveSheet()->setCellValueByColumnAndRow(41, $excel_row, $row->tgl_kon_masuk_in);
            $object->getActiveSheet()->setCellValueByColumnAndRow(42, $excel_row, $row->remark_op_in);
            $object->getActiveSheet()->setCellValueByColumnAndRow(43, $excel_row, $row->tgl_door_in); 
            $object->getActiveSheet()->setCellValueByColumnAndRow(44, $excel_row, $row->no_ship_uli_in);
            $object->getActiveSheet()->setCellValueByColumnAndRow(45, $excel_row, $row->tuj_ship_uli_in);
            $object->getActiveSheet()->setCellValueByColumnAndRow(46, $excel_row, $row->tgl_door_uli_in);
            $object->getActiveSheet()->setCellValueByColumnAndRow(47, $excel_row, $row->no_ship_uli2_in);
            $object->getActiveSheet()->setCellValueByColumnAndRow(48, $excel_row, $row->tuj_ship_uli2_in);
            $object->getActiveSheet()->setCellValueByColumnAndRow(49, $excel_row, $row->tgl_door_uli2_in);
