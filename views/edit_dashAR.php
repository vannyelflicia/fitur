                                ...
                                <div class="col-lg-8">
                                    ...
                                    <?php foreach ($editar as $r) { ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="<?php echo $r->no_faktur_ship ?>" type="text" name="no_faktur_ship">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="<?php echo $r->no_faktur_ship2 ?>" type="text" name="no_faktur_ship2">
                                        </div>
                                        <div class="form-group">
