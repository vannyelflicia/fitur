                            ...
                            <div class="col-md-offset-2">
                                <div class="col-lg-8">
                                    ...
                                    <?php foreach ($editar as $r) { ?>
                                        ...
                                        <div class="form-group">
                                            <input class="form-control" value="<?php echo $r->no_faktur_ship ?>" type="hidden" name="no_faktur_ship">
                                            <label>No. Faktur Pajak Shipment 1</label><br>
                                            <label><?php echo $r->no_faktur_ship ?></label>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input class="form-control" value="<?php echo $r->no_faktur_ship2 ?>" type="hidden" name="no_faktur_ship2">
                                            <label>No. Faktur Pajak Shipment 2</label><br>
                                            <label><?php echo $r->no_faktur_ship2 ?></label>
                                        </div>
                                        <div class="form-group">
