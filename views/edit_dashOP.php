                                ...
                                <div class="col-lg-8">
                                    ...
                                    <?php foreach ($editop as $p) { ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php if($p->in_out == "Out") { ?>
                                            <?php echo '<select name="no_container" id="no_container" class="form-control selectpicker" data-live-search="true" multiple required>
                                            <option selected="select">';?><?php echo ' '.$p->no_container.' ';?> <?php echo '</option>';?>
                                            <?php foreach ($nocon as $c) { ?>
                                            <?php echo '<option value="'; ?><?php echo ''.$c->no_container.' ';?>  <?php echo ''.$c->size.' "> ';?><?php echo' '.$c->no_container.' ';?>  <?php echo ' '.$c->size.' ';?><?php echo '</option>'; ?>
                                            <?php } 
                                            echo '</select>
                                            <input type="hidden" name="hidden_nocon" id="hidden_nocon">
                                            <p class="help-block">Type No. Container...</p>'; ?>
                                            <?php  } else { ?>
                                            <?php echo'<input type="text" class="form-control" disabled value=" '; ?><?php echo ' '.$p->no_container.' " > '?>
                                            <?php echo '<input type="hidden" class="form-control" name="no_container" value="';?><?php echo ' '.$p->no_container.' " '; ?>
                                            <?php } ?>
                                        </div>
                                         <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $p->in_out ?>" disabled>
                                            <input type="hidden" class="form-control" value="<?php echo $p->in_out ?>" name="in_out" ><!-- 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control"  value="<?php echo $p->tgl_kon_masuk ?>" name="tgl_kon_masuk">
                                        </div>
                                        <div class="form-group">
                                            <label>Remark</label>
                                            <textarea class="form-control" rows="3" name="remark_op"><?php echo $p->remark_op ?></textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="hidden" name="nomer" class="form-control" value="<?php echo $nomer ?>" >
                                        </div>
                                        <?php } ?>
