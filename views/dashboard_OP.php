                        ...
                        <div class="table-responsive-sm">
                            <table id="dtHorizontalExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                        <?php if($key->in_out=="Out")  {
                                        if($key->no_transaksi==$key->no_transaksi_in) { 
                                        echo ' '.$key->in_out.' &emsp; &emsp; &nbsp; &nbsp; <button type="button" class="btn btn-success btn-circle"><i class="fa fa-check"></i>
                                            </button>';
                                        }
                                        else 
                                        {
                                        echo ' '.$key->in_out.' &emsp; &emsp; &nbsp; <a href="formOP_in/'.$key->no_transaksi.' ">
                                        <button type="button" class="btn btn-warning btn-xs">create in</button>
                                        </a>'; 
                                        } 
                                        }
                                        ...
                                        <?php if($key->in_out=="Out")  {
                                        if($key->no_transaksi==$key->no_transaksi_in) { 
                                        echo ' <a href="delOP/'.$key->no_transaksi.'">
                                        <button type="button" class="btn btn-danger btn-circle disabled" onclick="return confirm(Apakah Anda Yakin Ingin Menghapus Data?)"><i class="glyphicon glyphicon-trash"></i></button>
                                        </a> ';
                                        }
                                        else 
                                        {
